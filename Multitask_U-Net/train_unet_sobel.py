...
from model.unetkuan_sobel import unet
...
##data2
    ...
    checkpoint = ModelCheckpoint(filepath='./log/unet_sobel_model_checkpoint_weight.h5',
                                 monitor='val_loss',
                                 save_best_only=True,
    ...
    history = model.fit_generator(
        ...
        epochs=epochs,
        verbose=1)
    model.save_weights('./log/unet_sobel_model_weight.h5')
