...
def create_pair_model(seg_width, seg_height, cls_width, cls_height, seg_loss_weight=0.5, cls_loss_weight=0.5):
    ...
    x_temp = Conv2D(64, (3, 3), name='cls_conv_1')(conv1_cls)
    x_temp = Activation('relu', name='cls_actv_1')(x_temp)
    x_temp = MaxPooling2D(pool_size=(2, 2), name='cls_max_pool_1')(x_temp)

    x_temp = Conv2D(128, (3, 3), name='cls_conv_2')(x_temp)
    x_temp = Activation('relu', name='cls_act_2')(x_temp)
    x_temp = MaxPooling2D(pool_size=(2, 2), name='cls_max_pool_2')(x_temp)

    x = Flatten(name='cls_flatten')(x_temp)
