...
from dataset_parser.generator import data_generator_pair
...
##data2
    ...
    a=1
    train_gen = data_generator_pair(nameList= train_name, segLabel=train_gt, cLabel=clabel_train,
                                    image_shape=(seg_img_height, seg_img_width, 1), nb_class=2,
                                    b_size=batch_size, mode='train')
    test_gen = data_generator_pair(nameList=val_name, segLabel=val_gt, cLabel=clabel_val,
                                    image_shape=(seg_img_height, seg_img_width, 1), nb_class=2,
