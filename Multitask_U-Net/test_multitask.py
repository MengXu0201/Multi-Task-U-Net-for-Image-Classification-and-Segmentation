...
def test_pair_model_handler():
    ...
    # load saved model
    model_name = './log/pair_model_model_weight.h5'
    ...
    # add another dataset for segmentation branch
    seg_data = '../BUS/data3/'
    ...
    # another dataset for segmentation
    # Segment dataset
    ...
    for index, name in enumerate(seg_test_add):
        ...
        # ignore the classification result because there ia no label
